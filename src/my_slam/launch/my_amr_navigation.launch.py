...
def generate_launch_description():
    ...
    param_dir = LaunchConfiguration(
        "params_file",
        default=os.path.join(
            get_package_share_directory("my_slam"), "params", "my_amr_param.yaml"
        ),
    )
    ...
    rviz_config_dir = os.path.join(get_package_share_directory("carter_navigation"), "rviz2", "my_navigation.rviz")
