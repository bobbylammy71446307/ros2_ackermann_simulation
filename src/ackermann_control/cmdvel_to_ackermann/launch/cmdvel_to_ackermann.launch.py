...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument("publish_period_ms", default_value="10", description="publishing dt in milliseconds"),
        DeclareLaunchArgument("track_width", default_value="1.1", description="wheel separation distance (m)"),
